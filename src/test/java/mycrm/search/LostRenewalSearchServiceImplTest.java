...
public class LostRenewalSearchServiceImplTest {

    @InjectMocks
    private LostRenewalSearchServiceImpl lostRenewalSearchService;
    ...
    @Before
    public void setup() {
        MockitoAnnotations.initMocks(lostRenewalSearchService);
    ...
    public final void shouldReturnSearchedListOfCustomerContractsWhenSearchingByLogType() throws Exception {
        ...
        ContractSearchResult contractSearchResult = lostRenewalSearchService.searchCustomerContract(contractSearch, 1);
    ...
    public final void shouldReturnSearchedListOfCustomerContractsWhenSearchingByFromDate() {
        ...
        ContractSearchResult returnedContractSearchResult = lostRenewalSearchService.searchCustomerContract(contractSearch, 1);
